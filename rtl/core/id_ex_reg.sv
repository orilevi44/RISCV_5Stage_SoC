...
module id_ex_reg (
    ...
    input  logic        id_mem_write_en,   // הוספתי
    input  logic        id_mem_to_reg_sel, // הוספתי
    input  logic        id_branch_en,      // הוספתי
    input  logic        id_jal_en,         // הוספתי
    input  logic        id_jalr_en,        // הוספתי
    input  logic        id_rs1_used,
    input  logic        id_rs2_used,
    
    // --- Outputs to Execute (EX) ---
    ...
    output logic        ex_mem_write_en,   // הוספתי
    output logic        ex_mem_to_reg_sel, // הוספתי
    output logic        ex_branch_en,      // הוספתי
    output logic        ex_jal_en,         // הוספתי
    output logic        ex_jalr_en,        // הוספתי
