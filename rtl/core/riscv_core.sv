...
module riscv_core (
    ...
    memory_stage u_memory_stage (
        ...
        .mem_branch_target_in(mem_branch_target), // הכתובת מהרגיסטר EX/MEM
        ...
        .ram_wr_data(data_mem_wr_data),
        .ram_wr_en(data_mem_wr_en), 
        .ram_rd_data(data_mem_rd_data),
        .mem_read_data(mem_rd_data), 
        .mem_branch_target_out(final_branch_addr), // הכתובת שיוצאת מהשלב
