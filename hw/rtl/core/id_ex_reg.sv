...
// Latches decoded instruction fields and control signals from Decode into Execute.
// Flush inserts a NOP bubble (used by load-use hazard and UART stall).
module id_ex_reg (
    input  logic         clk,
    input  logic         rst_n,
    input  logic         flush,
